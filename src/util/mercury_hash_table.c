...
static int hash_table_allocate_table(hg_hash_table_t *hash_table)
{
...
static void hash_table_free_entry(hg_hash_table_t *hash_table, hg_hash_table_entry_t *entry)
{
...
hg_hash_table_t *hg_hash_table_new(hg_hash_table_hash_func_t hash_func,
                          hg_hash_table_equal_func_t equal_func)
{
...
void hg_hash_table_free(hg_hash_table_t *hash_table)
{
...
void hg_hash_table_register_free_functions(hg_hash_table_t *hash_table,
                                        hg_hash_table_key_free_func_t key_free_func,
                                        hg_hash_table_value_free_func_t value_free_func)
{
...
static int hash_table_enlarge(hg_hash_table_t *hash_table)
{
...
int hg_hash_table_insert(hg_hash_table_t *hash_table, hg_hash_table_key_t key, hg_hash_table_value_t value)
{
	hg_hash_table_entry_t *rover;
...
int hg_hash_table_remove(hg_hash_table_t *hash_table, hg_hash_table_key_t key)
{
	hg_hash_table_entry_t **rover;
...
unsigned int hg_hash_table_num_entries(hg_hash_table_t *hash_table)
{
	return hash_table->entries;
}

void hg_hash_table_iterate(hg_hash_table_t *hash_table, hg_hash_table_iter_t *iterator)
{
	unsigned int chain;
...
int hg_hash_table_iter_has_more(hg_hash_table_iter_t *iterator)
{
	return iterator->next_entry != NULL;
}

hg_hash_table_value_t hg_hash_table_iter_next(hg_hash_table_iter_t *iterator)
{
