 ...
 *                             table.
 */
HG_UTIL_EXPORT hg_hash_table_t *
hg_hash_table_new(hg_hash_table_hash_func_t hash_func,
 ...
 */
HG_UTIL_EXPORT int
hg_hash_table_insert(hg_hash_table_t *hash_table,
 ...
 */
HG_UTIL_EXPORT hg_hash_table_value_t
hg_hash_table_lookup(hg_hash_table_t *hash_table,
        hg_hash_table_key_t key);
