...
int hg_hash_table_insert(hg_hash_table_t *hash_table,
...
hg_hash_table_value_t hg_hash_table_lookup(hg_hash_table_t *hash_table,
        hg_hash_table_key_t key);
...
void hg_hash_table_iterate(hg_hash_table_t *hash_table, hg_hash_table_iter_t *iter);
