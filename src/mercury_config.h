...
/* Build Options */
#define HG_HAS_BOOST
#define HG_HAS_CHECKSUMS
#define HG_HAS_SELF_FORWARD
#define HG_HAS_EAGER_BULK
/* #undef HG_HAS_XDR */
#define HG_HAS_POST_LIMIT
#define HG_POST_LIMIT 256
/* #undef HG_HAS_SM_ROUTING */
/* #undef HG_HAS_COLLECT_STATS */

#define HG_HAS_VERBOSE_ERROR
/* #undef HG_HAS_DEBUG */
