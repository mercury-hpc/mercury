...
/* this should be internal and depend on the plugin */
...
struct na_cb_info {
    ...
    /* Struct containing return parameters */
    union info {
 ...
 *
 * \param port_name [IN]        host address with port number (e.g.,
...
NA_Initialize(const char *port_name, na_bool_t listen);
...
NA_Addr_lookup(na_class_t *network_class,
        int (*callback)(const struct na_cb_info *), void *arg,
 ...
 */
NA_EXPORT na_return_t
NA_Addr_free(na_class_t *network_class,
        na_addr_t addr);
 ...
 */
NA_EXPORT na_return_t
NA_Mem_handle_create(na_class_t *network_class,
 ...
 */
NA_EXPORT na_return_t
NA_Mem_handle_free(na_class_t *network_class,
        na_mem_handle_t mem_handle);
 ...
 */
NA_EXPORT na_return_t
NA_Mem_deregister(na_class_t *network_class,
        na_mem_handle_t mem_handle);
 ...
 * TODO in main na layer (locking with condition variable)
 *
 * \param timeout [IN]          timeout (in milliseconds)
