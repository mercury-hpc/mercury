...
static size_t mchecksum_crc32c_get_size(struct mchecksum_class *checksum_class);
static int mchecksum_crc32c_get(struct mchecksum_class *checksum_class,
...
static const struct mchecksum_class mchecksum_crc32_g = {
    ...
    mchecksum_crc32c_get_size,
    mchecksum_crc32c_get,
...
mchecksum_crc32c_init(struct mchecksum_class *checksum_class)
{
    ...
    *checksum_class = mchecksum_crc32_g;
    ...
    mchecksum_crc32c_reset(checksum_class);
...
/*---------------------------------------------------------------------------*/
static int
mchecksum_crc32c_destroy(struct mchecksum_class *checksum_class)
{
...
/*---------------------------------------------------------------------------*/
static int
mchecksum_crc32c_reset(struct mchecksum_class *checksum_class)
{
    *(mchecksum_uint32_t *) checksum_class->data = ~(mchecksum_uint32_t)0;
...
/*---------------------------------------------------------------------------*/
static size_t
mchecksum_crc32c_get_size(struct mchecksum_class MCHECKSUM_UNUSED *checksum_class)
{
...
/*---------------------------------------------------------------------------*/
static int
mchecksum_crc32c_get(struct mchecksum_class *checksum_class,
    void *buf, size_t size, int finalize)
{
    int ret = MCHECKSUM_SUCCESS;
